...
// let cumple = mayoriaEdad(ape, nom, edad);
let cumpleArrow = (miApellido, miNombre, miEdad) =>{
    console.log("Apellido y nombre: " + miApellido + ", " + miNombre);
    if (miEdad >= 18) {
        return "Cumple";
    }
...
console.log("Cumple con la edad?", cumpleArrow(ape,nom,edad))
cumpleArrow = 2536987
console.log(cumpleArrow);
